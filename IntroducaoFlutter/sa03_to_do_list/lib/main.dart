...
final List<Map<String, dynamic>> _tarefas = [];
            ...
            Expanded(
                ...
                itemBuilder: (context,index) => ListTile(
                  title: Text(_tarefas[index]["titulo"],
                            ...
                            leading: Checkbox(value: _tarefas[index]["concluida"], onChanged: (bool ? valor)=> setState(() { //envia a mudança de estado para a classe
  ...
  void _adicionarTarefa(){
    if(_tarefaController.text.trim().isNotEmpty){
      setState(() {
        _tarefas.add({"titulo":_tarefaController.text.trim(), 
                      "concluida":false});
